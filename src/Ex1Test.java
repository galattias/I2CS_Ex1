...
class Ex1Test {
	...
	@Test
	/**
	 * Tests that adding ZERO does not change the polynomial.
	 */
	void testAddZeroIdentity() {
		double[] p1 = Ex1.add(po1, Ex1.ZERO);
		double[] p2 = Ex1.add(Ex1.ZERO, po2);
		assertTrue(Ex1.equals(po1, p1));
		assertTrue(Ex1.equals(po2, p2));
	}
	 ...
	 */
	void testPolyAndFromString() {
		double[] p = {2, -3.5, 0, 4};
		String s = Ex1.poly(p);
		double[] p2 = Ex1.getPolynomFromString(s);
		assertTrue(Ex1.equals(p, p2));
	}
